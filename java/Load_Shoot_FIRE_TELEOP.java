...
public class Load_Shoot_FIRE_TELEOP extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            //move claw and hand using the left/right bumper buttons
            boolean armmove = gamepad1.left_bumper;
            boolean handmove = gamepad1.right_bumper;
...
/*            if (handmove){
            ...
            // Debug
            telemetry.addData("clawPos: ", hand.getDirection());
