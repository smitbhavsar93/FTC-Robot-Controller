...
public class Load_Shoot_FIRE_AUTONOMOUS extends LinearOpMode {
    ...
    //declare all variables for driving motors
    ...
    //main method where we put all the drive / shooting functions inside of
    public void Main(){
    ...
    public void runOpMode() {
        ...
        //call the "Main" method for the robot to actually do stuff
        Main();
    }
}